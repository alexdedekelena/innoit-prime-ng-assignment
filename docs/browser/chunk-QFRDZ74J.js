...
function Zt(n) {
  ...
  return (
    X.style &&
      ...
      !e &&
        wt &&
        (e = "Webkit" + n.charAt(0).toUpperCase() + n.slice(1) in X.style)),
    e
  );
}
function Rs(n) {
...
function Is(n, e, t) {
  ...
  if (typeof n == "string") {
    let o = n.match(s);
    if (o === null) return e.push(bt(n)), { duration: 0, delay: 0, easing: "" };
...
function es(n, e, t) {
  ...
  i.length &&
    i.forEach((r) => {
      s.hasOwnProperty(r) || t.push(As(r));
    });
}
...
function Bs(n, e) {
  ...
  return (
    typeof n == "string"
      ? n.split(/\s*,\s*/).forEach((s) => Qs(s, t, e))
      : t.push(n),
    t
  );
}
...
var rs = "",
  tt = class {
    ...
    visitTransition(e, t) {
      ...
      let s = O(this, ee(e.animation), t),
        i = Bs(e.expr, t.errors);
      return {
        type: S.Transition,
        matchers: i,
        animation: s,
    ...
    visitGroup(e, t) {
      ...
      return (
        (t.currentTime = i), { type: S.Group, steps: r, options: J(e.options) }
      );
    }
    visitAnimate(e, t) {
            ...
            a.forEach((o, l) => {
              ...
              h &&
                (r != i &&
                  r >= h.startTime &&
                  i <= h.endTime &&
                  (t.errors.push(kt(l, h.startTime, h.endTime, r, i)),
                  (c = !1)),
                (r = h.startTime)),
    ...
    visitReference(e, t) {
      return {
        type: S.Reference,
        animation: O(this, ee(e.animation), t),
        options: J(e.options),
      };
    }
...
function J(n) {
  return (
    n ? ((n = fe({}, n)), n.params && (n.params = Gs(n.params))) : (n = {}), n
  );
}
function We(n, e, t) {
...
var it = class {
    ...
    _applyAnimationRefDelays(e, t, s) {
      for (let i of e) {
        ...
        if (r) {
          let a =
            typeof r == "number" ? r : V(te(r, i?.params ?? {}, t.errors));
          s.delayNextStep(a);
        }
      }
    }
    ...
    visitSequence(e, t) {
      ...
      if (
        ...
        i.previousNode.type == S.Style &&
          (i.currentTimeline.snapshotCurrentStyles(), (i.previousNode = Ne));
        let a = V(r.delay);
        i.delayNextStep(a);
      }
      e.steps.length &&
    ...
    visitStagger(e, t) {
      ...
      O(this, e.animation, t),
        ...
        (s.currentStaggerTime =
          i.currentTime - c + (i.startTime - s.currentTimeline.startTime));
    }
  },
  Ne = {},
  nt = class n {
      ...
      if (r) {
        ...
        a || (a = this.options.params = {}),
          Object.keys(r).forEach((o) => {
            (!t || !a.hasOwnProperty(o)) && (a[o] = te(r[o], a, this.errors));
          });
      }
    }
    _copyOptions() {
  ...
  Me = class n {
    ...
    forwardFrame() {
      (this.duration += Hs), this._loadKeyframe();
    }
    forwardTime(e) {
    ...
    setStyles(e, t, s, i) {
      ...
      let r = (i && i.params) || {},
        a = xs(e, this._globalTimelineStyles);
      for (let [o, l] of a) {
        let u = te(l, r, s);
        this._pendingStyles.set(o, u),
          this._localTimelineStyles.has(o) ||
            this._backFill.set(o, this._globalTimelineStyles.get(o) ?? z),
...
var He = {},
  Ce = class {
    ...
    match(e, t, s, i) {
      return ei(this.ast.matchers, e, t, s, i);
    }
    buildStyles(e, t, s) {
    ...
    build(e, t, s, i, r, a, o, l, u, h) {
      let c = [],
        _ = (this.ast.options && this.ast.options.params) || He,
        y = (o && o.params) || He,
...
var ot = class {
  ...
  constructor(e, t, s) {
    (this.name = e),
      ...
      (this.fallbackTransition = si(e, this.states));
  }
  get containsQueries() {
...
var ii = new ie(),
  ...
  ni = ".ng-animate-queued",
  Ye = "ng-animate-disabled",
  ri = ".ng-animate-disabled",
  ai = "ng-star-inserted",
  oi = ".ng-star-inserted",
  li = [],
  Ss = {
  ...
  ut = class {
    ...
    listen(e, t, s, i) {
      ...
      let r = R(this._elementListeners, e, []),
  ...
  ct = class {
    ...
    markElementAsDisabled(e, t) {
      t
        ...
        : this.disabledNodes.has(e) &&
          (this.disabledNodes.delete(e), se(e, Ye));
    }
    removeNode(e, t, s) {
      if (we(t)) {
    ...
    processLeaveNode(e) {
      ...
      e.classList?.contains(Ye) && this.markElementAsDisabled(e, !1),
        this.driver.query(e, ri, !0).forEach((s) => {
    ...
    _flushAnimations(e, t) {
      ...
      for (let d = 0; d < this.collectedLeaveElements.length; d++) {
        ...
        p &&
          ...
          w.add(m),
          p.hasAnimation
            ? this.driver.query(m, oi, !0).forEach((T) => w.add(T))
            : A.add(m));
      }
      let C = new Map(),
        N = ds(_, Array.from(w));
      ...
      for (let d = this._namespaceList.length - 1; d >= 0; d--)
        this._namespaceList[d].drainQueuedTransitions(t).forEach((p) => {
          ...
          if (Q) {
            T.onStart(() => G(P, b.fromStyles)),
              T.onDestroy(() => K(P, b.toStyles)),
              i.push(T);
            return;
          }
          ...
          b.timelines.forEach((M) => {
            (M.stretchStartingKeyframe = !0),
              this.disabledNodes.has(M.element) || St.push(M);
          }),
            (b.timelines = St),
          ...
          a.push(vs),
            ...
            b.preStyleProps.forEach((M, H) => {
              if (M.size) {
                let F = l.get(H);
                F || l.set(H, (F = new Set())),
                  M.forEach((de, Le) => F.add(Le));
              }
            }),
            b.postStyleProps.forEach((M, H) => {
              let F = u.get(H);
              F || u.set(H, (F = new Set())), M.forEach((de, Le) => F.add(Le));
            });
        });
      if (B.length) {
        let d = [];
      ...
      a.forEach((d) => {
        ...
        s.has(m) &&
          (D.set(m, m),
          this._beforeAnimationBuild(d.player.namespaceId, d.instruction, k));
      }),
        i.forEach((d) => {
          let m = d.element;
      ...
      for (let d = 0; d < v.length; d++) {
        let m = v[d],
          p = m[q];
        if ((se(m, re), p && p.hasAnimation)) continue;
        let T = [];
        if (o.size) {
          let Q = o.get(m);
          Q && Q.length && T.push(...Q);
    ...
    _beforeAnimationBuild(e, t, s) {
      ...
      for (let l of t.timelines) {
        ...
        this._getPreviousPlayers(u, h, a, o, t.toState).forEach((y) => {
          ...
          f.beforeDestroy && f.beforeDestroy(), y.destroy(), c.push(y);
        });
      }
      G(r, t.fromStyles);
    }
    _buildAnimation(e, t, s, i, r, a) {
      let o = t.triggerName,
        ...
        _ = t.timelines.map((f) => {
          ...
          h.add(g);
          let v = g[q];
          if (v && v.removedBeforeQueried) return new Y(f.duration, f.delay);
          let w = g !== l,
            A = mi((s.get(g) || li).map((k) => k.getRealPlayer())).filter(
              (k) => {
                let D = k;
      ...
      u.forEach((f) => {
        R(this.playersByQueriedElement, f.element, []).push(f),
          f.onDone(() => ci(this.playersByQueriedElement, f.element, f));
      }),
        h.forEach((f) => I(f, Ue));
      let y = $(_);
      return (
...
function hs(n, e, t, s, i) {
  ...
  s.forEach((l, u) => {
    let h = new Map();
    l.forEach((c) => {
      let _ = e.computeStyle(u, c, i);
      h.set(c, _), (!_ || _.length == 0) && ((u[q] = ui), a.push(u));
    }),
      n.set(u, h);
  });
  let o = 0;
...
var yi = (() => {
  class n {
    ...
    start() {
      this._state < 1 &&
        (this._startStyles &&
          K(this._element, this._startStyles, this._initialStyles),
        (this._state = 1));
    }
    finish() {
      this.start(),
        this._state < 2 &&
          ...
          this._endStyles &&
            (K(this._element, this._endStyles), (this._endStyles = null)),
          (this._state = 1));
    }
    destroy() {
      this.finish(),
        this._state < 3 &&
          ...
          this._startStyles &&
            (G(this._element, this._startStyles), (this._endStyles = null)),
          this._endStyles &&
            (G(this._element, this._endStyles), (this._endStyles = null)),
          K(this._element, this._initialStyles),
          (this._state = 3));
    }
  }
...
function Ni(n, e) {
  return n === "noop"
    ? new ke(e, new gs(), new xe())
    : new ke(e, new ht(), new et());
}
var ms = class {
    _driver;
    _animationAst;
